    ...
    return (
      <div className="flex flex-col items-center min-h-screen p-6 sm:p-8 bg-background text-foreground">
        ...
        {files.length === 0 ? (
          ...
          <>
            <button className="bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 text-white px-6 py-3 my-8 text-xl rounded-xl shadow-lg hover:from-blue-600 hover:via-blue-700 hover:to-blue-800 transition-all duration-300 ease-in-out transform hover:scale-105 active:scale-95 active:shadow-none md:px-8 md:py-3">
              Upload file 
            </button>
          </>
        )}
